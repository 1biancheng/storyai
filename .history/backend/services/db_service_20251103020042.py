...
try:
    ...
    logging.warning("Database dependencies not available. Install: pip install asyncpg sqlalchemy[asyncio] numpy")
    ...
    async def insert_document(self, title: str, content: str, embedding: Optional[List[float]] = None,
        ...
        async with self.get_session() as session:
            ...
            doc = Document(
                ...
                source=source,
                doc_metadata=doc_metadata or {},  # 直接传递字典,不需要json.dumps
