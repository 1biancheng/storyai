...
公式示例(推荐JSON):
{
  "query": "protagonist与villain初次相遇的紧张场景",
  "top_k": 8,
  "threshold": 0.75,
  "order": "similarity_desc",
  "meta_filters": {"role": ["protagonist", "villain"], "emotion": ["紧张"]}
}
...
THRESHOLD: 0.75
ORDER: similarity_desc
FILTER: role=protagonist,villain; emotion=紧张
"""
...
def parse_formula(expression: str) -> FormulaPlan:
    ...
    for line in expression.splitlines():
        ...
        if m:
            ...
            # role=protagonist,villain; emotion=紧张
