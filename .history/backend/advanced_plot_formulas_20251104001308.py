...
class StarPlotFormulaEngine:
    ...
    def _create_three_act_template(self) -> TemplateConfiguration:
        ...
        plot_points = [
            PlotPoint(
                ...
                star_features={
                    "explicit_symbols": ["sunny_morning", "bustling_streets"],
                    "implicit_symbols": ["protagonist_flash_of_sadness", "tension_in_air"],
                    "composite_labels": ["calm_life_but_restless_heart"]
                },
                required_elements=["protagonist_introduction", "world_setting", "initial_conflict"],
                optional_elements=["supporting_character_introduction", "background_story"],
            ...
            PlotPoint(
                ...
                description="major_event_breaking_status_quo",
                position=0.25,
                emotional_intensity=0.6,
                conflict_level=0.7,
                character_change=0.3,
                star_features={
                    "explicit_symbols": ["sudden_message", "unexpected_encounter"],
                    "implicit_symbols": ["protagonist_heart_racing", "sweaty_palms"],
                    "composite_labels": ["fear_but_must_face"]
                },
                required_elements=["major_event", "protagonist_decision", "new_goal"],
                optional_elements=["ally_appearance", "enemy_appearance"],
            ...
            PlotPoint(
                ...
                description="protagonist faces challenges, conflict escalation",
                position=0.5,
            ...
            PlotPoint(
                id="act2_dark_moment",
                name="dark_moment",
                description="protagonist faces greatest challenge",
                position=0.75,
            ...
            PlotPoint(
                ...
                star_features={
                    "explicit_symbols": ["final_battle", "life_and_death_confrontation"],
                    "implicit_symbols": ["inner_peace", "enlightenment"],
                    "composite_labels": ["persist_even_if_fail"]
                },
                required_elements=["final_conflict", "character_growth_complete", "main_problem_solved"],
                optional_elements=["unexpected_twist", "sacrifice"],
    ...
    def _create_hero_journey_template(self) -> TemplateConfiguration:
        ...
        plot_points = [
            PlotPoint(
                id="ordinary_world",
                name="平凡世界",
                description="protagonist_daily_life",
                position=0.1,
                emotional_intensity=0.2,
                conflict_level=0.1,
                character_change=0.0,
                star_features={
                    "explicit_symbols": ["ordinary_town", "ordinary_family"],
                    "implicit_symbols": ["inner_longing", "dissatisfaction_with_status_quo"],
                    "composite_labels": ["stable_life_but_empty_heart"]
                },
                required_elements=["protagonist_introduction", "daily_life", "inner_desire"],
                optional_elements=["supporting_character_introduction", "world_rules"],
                transition_rules=["change_brewing_in_calm"],
                backtrack_probability=0.05,
                evolution_triggers=["encounter_call"]
            ),
            PlotPoint(
                id="call_to_adventure",
                name="冒险召唤",
                description="protagonist receives the call to adventure",
                position=0.2,
            ...
            "composite_labels": ["既害怕又兴奋"]
                ...
                required_elements=["召唤事件", "protagonist hesitates", "最终接受"],
            ...
            PlotPoint(
                id="supreme_ordeal",
                name="严峻考验",
                description="protagonist faces life and death test",
                position=0.8,
                emotional_intensity=1.0,
                conflict_level=1.0,
                character_change=0.9,
        ...
        additional_points = [
            ...
            PlotPoint(
                ...
                conflict_level=0.7,
                character_change=1.0,
                star_features={"implicit_symbols": ["inner_transformation", "wisdom_gained"]},
                required_elements=["final_test", "final_change"],
                optional_elements=["sacrifice"], transition_rules=["complete_transformation"],
                backtrack_probability=0.1, evolution_triggers=["become_hero"]
            ),
            PlotPoint(
                id="return_elixir",
                name="带着仙丹回归",
    ...
    def _create_hero_journey_field_mappings(self) -> List[StarFieldMapping]:
        ...
        return [
            ...
            StarFieldMapping(
                ...
                generation_rules=[
                    "explicit_mode:protagonist crosses{boundary}",
        ...
        plot_points = [
            ...
            PlotPoint(
                ...
                star_features={
                    ...
                    "composite_labels": ["seeing_rainbow_after_storm"]
                },
                required_elements=["problem_solved", "emotion_confirmed", "happy_ending"],
                optional_elements=["romantic_proposal", "future_planning"],
    ...
    def _create_mystery_template(self) -> TemplateConfiguration:
        ...
        plot_points = [
            PlotPoint(
                ...
                character_change=0.1,
                star_features={
                    "explicit_symbols": ["discovering_body", "seeing_blood"],
                    "implicit_symbols": ["ominous_feeling", "tense_atmosphere"],
                    "composite_labels": ["calm_surface_but_hidden_secrets"]
                },
                required_elements=["crime_scene", "preliminary_clues", "detective_intervention"],
                optional_elements=["suspect_appearance", "motive_hint"],
                transition_rules=["suspense_established"],
                backtrack_probability=0.1,
                evolution_triggers=["discover_new_clues"]
            ),
            PlotPoint(
                ...
                optional_elements=["suspects increase", "动机复杂化"],
            ...
            PlotPoint(
                ...
                backtrack_probability=0.2,
                evolution_triggers=["obtain_key_evidence"]
            ),
            PlotPoint(
                id="truth_revelation",
                ...
                character_change=0.8,
                star_features={
                    "explicit_symbols": ["culprit confesses", "conclusive evidence"],
                    "implicit_symbols": ["detective's satisfaction", "justice is served"],
                    "composite_labels": ["not only solved the case but also grew"]
                },
                required_elements=["truth revealed", "culprit's identity", "motive explained"],
                optional_elements=["culprit's confession", "unexpected truth"],
                transition_rules=["case resolved"],
                backtrack_probability=0.05,
                evolution_triggers=["case ends"]
            )
        ]
    ...
    def _generate_setting_for_element(self, element: str, parameters: Dict[str, Any]) -> str:
        ...
        settings = {
            "protagonist_introduction": "ordinary_town_street",
                "daily_life": "daily_life_scenes",
                "inner_desire": "quiet_thinking_space",
                "major_event": "bustling_public_place",
                "crime_scene": "dark_crime_scene",
                "detective_intervention": "professional_investigation_environment"
        }
    ...
    def _generate_characters_for_element(self, element: str, parameters: Dict[str, Any]) -> List[str]:
        ...
        characters = {
            "protagonist_introduction": ["protagonist", "narrator"],
            "daily_life": ["protagonist", "family", "neighbors"],
            "inner_desire": ["protagonist", "inner_voice"],
            "major_event": ["protagonist", "key_characters", "observers"],
            "crime_scene": ["detective", "victim", "suspects"],
            "detective_intervention": ["detective", "assistant", "related_personnel"]
        }
        return characters.get(element, ["protagonist"])
    ...
    def _generate_improvement_suggestions(self, content: str) -> List[Dict[str, Any]]:
        ...
        if len(explicit_symbols) < 5:
            suggestions.append({
                ...
                "examples": ["suddenly_stand_up", "suddenly_turn_around", "sunny_morning"]
            })
        ...
        if len(implicit_symbols) < 3:
            suggestions.append({
                ...
                "examples": ["eyes_flickering", "corners_of_mouth_slightly_raised", "wave_of_emotion_in_heart"]
            })
        ...
        if len(composite_labels) < 2:
            suggestions.append({
                ...
                "examples": ["calm_on_surface_but_turbulent_inside", "not_escape_but_face_bravely"]
            })
    ...
    def _extract_characters(self, content: str) -> List[str]:
        ...
        common_names = ["xiaoming", "xiaohong", "zhangsan", "lisi", "wangwu", "protagonist", "supporting_character", "detective", "suspect"]
        found_characters = []
        ...
        return found_characters if found_characters else ["protagonist"]
...
if __name__ == "__main__":
    ...
    sample_content = """
    xiaoming suddenly stood up, with determination shining in his eyes. Although his heart was filled with fear, he decided to face it bravely.
    The sunlight streamed through the window, illuminating his pale but determined face. Not choosing to escape, but choosing to persevere,
    this made him feel an unprecedented strength surging in his heart.
    """
