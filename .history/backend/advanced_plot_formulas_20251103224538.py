        ...
        "composite_label_weight": 0.25,
            ...
            "evolution_logic_rules": {
                ...
                "reverse_correction_mechanism": {
                    "excessive_explicit_correction": -0.15,
                    "excessive_implicit_correction": -0.1,
    ...
    def _create_hero_journey_template(self) -> TemplateConfiguration:
        ...
        return TemplateConfiguration(
            ...
            star_parameters={
                ...
                "reverse_correction_intensity": 0.2
            },
            generation_constraints={
                "minimum_paragraph_count": 80,
                "maximum_paragraph_count": 300,
                "emotional_intensity_change": "progressive",
                "character_growth_pattern": "spiral_upward"
            },
            quality_thresholds={
            ...
            evolution_rules={
                "evolution_trigger_conditions": ["character_growth_stagnation", "unnatural_emotional_change"],
                "evolution_directions": ["enhance_inner_description", "adjust_growth_rhythm"],
                "evolution_constraints": ["maintain_hero_journey_structure", "preserve_character_core_traits"]
            }
        )
    ...
    def _create_hero_journey_field_mappings(self) -> List[StarFieldMapping]:
        ...
        return [
            StarFieldMapping(
                ...
                generation_rules=[
                    "explicit_mode:from_{old_trait}_to_{new_trait}",
                    "implicit_mode:gradually_{emotion}_in_heart",
                    "composite_mode:although_{appearance}_but_{inner_change}"
                ],
                weight=0.5,
                dependencies=["plot_progression", "character_arc"],
                validation_rules=["transformation_reasonableness_check", "process_naturalness_check"],
            ...
            StarFieldMapping(
                ...
                generation_rules=[
                    "explicit_mode:mentor_says_{wisdom}",
                    "implicit_mode:eyes_reveal_{wisdom}",
                    "composite_mode:not_directly_tell_{lesson}_but_let_protagonist_understand_through_{method}"
                ],
                weight=0.3,
                dependencies=["mentor_character", "hero_readiness"],
                validation_rules=["mentor_image_consistency", "guidance_method_reasonableness"],
                evolution_factor=0.15
            ),
            StarFieldMapping(
