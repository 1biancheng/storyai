...
class XingdaPlotFormulaEngine:
    ...
    def _evolve_plot_point(self, point: PlotPoint, evolution_factor: float) -> PlotPoint:
        ...
        # Evolve Xingyi features
        evolved_xingyi_features = self._evolve_xingyi_features(point.xingda_features, evolution_factor)
        ...
        return PlotPoint(
            ...
            xingda_features=evolved_xingyi_features,
