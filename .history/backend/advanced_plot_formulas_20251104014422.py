...
>>>>>>> 040e555 (更新项目:将'星达'替换为'星矢',更新多个组件和服务)
                weight=0.3,
    ...
    def _create_hero_journey_template(self) -> TemplateConfiguration:
        ...
        additional_points = [
            ...
            PlotPoint(
                id="return_elixir",
                name="带着仙丹回归",
                description="主角带着奖励回归平凡世界,分享成果",
                position=1.0,
                emotional_intensity=0.5,
                conflict_level=0.1,
                character_change=1.0,
                star_features={"explicit_symbols": ["回到故乡", "分享成果"]},
    ...
    def _create_mystery_template(self) -> TemplateConfiguration:
        ...
        plot_points = [
            ...
            PlotPoint(
                ...
                name="突破时刻",
                description="主角获得关键发现,接近真相",
                position=0.7,
                emotional_intensity=0.8,
                conflict_level=0.8,
                character_change=0.6,
                star_features={
                    "explicit_symbols": ["关键发现", "重要证据"],
                    "implicit_symbols": ["灵光一闪", "突然明白"],
                    "composite_labels": ["虽然不是直接证据但是能够推断出真相"]
                },
...
>>>>>>> 040e555 (更新项目:将'星达'替换为'星矢',更新多个组件和服务)
            ...
            evolution_rules={
                "evolution_triggers": ["线索过于明显", "推理跳跃过大"],
                "evolution_directions": ["增加误导线索", "强化推理逻辑"],
                "evolution_constraints": ["保持真相不变", "维护侦探形象"]
            }
        )
