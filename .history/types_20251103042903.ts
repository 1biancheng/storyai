...
export interface ProjectData {
  ...
  enableThinkingMode?: boolean; // New: For advanced Gemini Pro thinking
  enableSearchGrounding?: boolean; // New: For Gemini Flash search grounding
  searchProvider?: 'google' | 'bing' | 'baidu'; // New: Provider-agnostic search selection
...
export interface ModelConfig {
  ...
  apiUrl?: string;
  isDefault?: boolean;
  isGemini?: boolean; // To identify the special default Gemini config
}
...
export interface LLMModel {
  ...
  name: string;
  modelId: string;
  type: 'gemini' | 'openai' | 'anthropic' | string; // Allow custom types
}
