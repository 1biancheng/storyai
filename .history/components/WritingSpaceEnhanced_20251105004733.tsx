...
import * as modelManager from '../sample_data/services/modelManager';
...
export default function WritingSpaceEnhanced({ project }: WritingSpaceEnhancedProps) {
  ...
  // Prevent auto-scrolling to bottom on component mount
  useEffect(() => {
    ...
    // Also prevent any future auto-scrolls
    const preventAutoScroll = () => {
      window.scrollTo(0, 0);
    };
    
    // Add a short delay to ensure it runs after any other scroll events
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50 overflow-hidden" style={{ scrollBehavior: 'auto', overscrollBehavior: 'none' }}>
      {/* Main Content Container with Scroll Constraints */}
      <div className="flex flex-col flex-1 overflow-hidden" style={{ scrollBehavior: 'auto', scrollPaddingTop: '0', scrollPaddingBottom: '0', overscrollBehavior: 'none' }}>
        ...
        <div className="w-80 border-l border-gray-200 bg-white overflow-hidden flex flex-col">
          ...
          <div className="flex-1 flex flex-col">
            <AIChatPanel
              ...
              currentChapterContent={selectedChapter?.content || ''}
            />
          </div>
        </div>
      </div>
