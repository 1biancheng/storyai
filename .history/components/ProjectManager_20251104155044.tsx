...
import * as timeService from '../services/timeService.ts';
...
const ProjectManager: React.FC<ProjectManagerProps> = ({ onProjectSelect }) => {
    ...
    const handleSubmitProject = async () => {
        ...
        if (editingProjectId) {
            ...
            // Create new project
            try {
                // Get server time for project creation
                const serverTime = await timeService.getServerIsoString();
                ...
                console.error('Failed to get server time, using local time instead:', error);
