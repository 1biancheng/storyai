...
import { AgentWorkflow, AgentRole, WorkflowNode, LLMModel } from '../../types';
import { getPromptCardIdForAgent } from './agentPrompts';
...
const BACKEND_BASE_URL = typeof window !== 'undefined' ? (window as any).VITE_BACKEND_URL || 'http://localhost:8000' : 'http://localhost:8000';
