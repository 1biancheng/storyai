...
const App: React.FC = () => {
    ...
    return (
        <ThemeProvider>
            <div className="h-screen max-h-screen antialiased overflow-hidden bg-gray-50 dark:bg-[#121212] text-gray-900 dark:text-[#E2E2E2] flex flex-col" style={{ 
                backgroundColor: 'var(--editor-bg-color, #121212)',
                color: 'var(--editor-text-color, #E2E2E2)'
            }}>

                <header className="flex-shrink-0 bg-white dark:bg-[#1E1E1E] z-10 shadow-sm" style={{ 
                    backgroundColor: 'var(--primary-color, #1E1E1E)',
                    color: 'var(--primary-text-color, #FFFFFF)'
                }}>
                    <div className="px-6 py-0.5 border-b border-gray-200 dark:border-white/10 flex justify-between items-center">
                       <h1 className="text-sm font-bold text-gray-900 dark:text-white">小说创作系统</h1>
                       <TimeDisplay 
