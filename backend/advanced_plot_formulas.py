...
class XingdaPlotFormulaEngine:
    ...
    def _generate_improvement_suggestions(self, content: str) -> List[Dict[str, Any]]:
        """Generate improvement suggestions based on Xingyi analysis"""
        suggestions = []
...
if __name__ == "__main__":
    ...
    engine = XingyiPlotFormulaEngine()
    ...
    print(f"星矢特征分数: {result['quality_metrics']['xingyi_compliance']:.2f}")
    ...
    print(f"星矢总分: {analysis['xingyi_score']:.2f}")
