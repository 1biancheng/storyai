...
import { Settings, Trash2, Sun, Moon, Plus, Save, Info, CheckCircle, Edit, X, Upload, Download, Eraser, TestTube, Loader, AlertCircle, Clock, Palette } from 'lucide-react';
import ThemeSettings from '../src/components/ThemeSettings.tsx';
...
import * as openAIService from '../sample_data/services/openAIService.ts';
import * as anthropicService from '../sample_data/services/anthropicService.ts';
        ...
        <div className="p-6 bg-white dark:bg-[#1E1E1E] h-full overflow-y-auto text-gray-900 dark:text-[#E2E2E2] rounded-xl shadow-md border border-gray-200 dark:border-[rgba(255,255,255,0.05)]">
            ...
            <div className="max-w-2xl space-y-6">
                 <div className="p-4 rounded-lg bg-gray-50 dark:bg-[#2C2C2C] border border-gray-200 dark:border-white/10">
                    <h3 className="font-semibold text-gray-900 dark:text-white mb-3">外观和主题</h3>
                    ...
                    <button
                        ...
                        className="w-full flex items-center justify-center gap-2 h-10 px-4 py-2 bg-purple-100 hover:bg-purple-200 dark:bg-purple-500/20 dark:hover:bg-purple-500/30 text-purple-700 dark:text-purple-300 font-semibold rounded-lg transition-colors"
                    >
                        <Palette size={16} />
                        <span>高级主题设置</span>
                    </button>
                ...
                <div className="p-4 rounded-lg bg-gray-50 dark:bg-[#2C2C2C] border border-gray-200 dark:border-white/10">
                    ...
                    <div className="space-y-2 mb-4">
                     ...
                     <div className="p-4 border-t border-gray-200 dark:border-white/10 bg-white dark:bg-[#2C2C2C] rounded-b-lg">
                        ...
                        <div className="space-y-3">
                            <div>
                                ...
                                <input id="model-name" name="name" value={formState.name} onChange={handleInputChange} placeholder="一个易于识别的名称" className="w-full h-8 px-2.5 border border-gray-300 dark:border-white/10 bg-white dark:bg-[#2C2C2C] text-gray-900 dark:text-white rounded-lg text-sm" />
                            </div>
                             <div>
                                ...
                                <input id="model-id" name="modelId" value={formState.modelId} onChange={handleInputChange} placeholder="服务商提供的模型标识符" className="w-full h-8 px-2.5 border border-gray-300 dark:border-white/10 bg-white dark:bg-[#2C2C2C] text-gray-900 dark:text-white rounded-lg text-sm" />
                            </div>
                             <div>
                                <label htmlFor="api-key" className="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">API 密钥</label>
                                <input id="api-key" type="password" name="apiKey" value={formState.apiKey} onChange={handleInputChange} placeholder="您的 API 密钥" className="w-full h-8 px-2.5 border border-gray-300 dark:border-white/10 bg-white dark:bg-[#2C2C2C] text-gray-900 dark:text-white rounded-lg text-sm" />
                            </div>
                             <div>
                                <label htmlFor="api-url" className="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">API 地址 (可选)</label>
                                <input id="api-url" name="apiUrl" value={formState.apiUrl} onChange={handleInputChange} placeholder="用于代理或兼容 OpenAI 的服务" className="w-full h-8 px-2.5 border border-gray-300 dark:border-white/10 bg-white dark:bg-[#2C2C2C] text-gray-900 dark:text-white rounded-lg text-sm" />
                            </div>
                        </div>
