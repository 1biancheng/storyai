...
import { generateStoryStream, listFormulas, upsertFormula, ingestStoryText, getStoryCategories, submitSplicingFeedback } from '../sample_data/services/storyService.ts';
...
const backendBase = (import.meta as any)?.env?.VITE_BACKEND_URL || 'http://localhost:8000';
  ...
  useEffect(() => {
    (async () => {
      try {
        const resp = await fetch(`${backendBase}/api/v1/story/templates`);
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="md:col-span-1 space-y-3">
          ...
          <div className="mt-4 p-3 rounded-md border border-gray-300 dark:border-white/10 bg-gray-50 dark:bg-[#1C1C1C] space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2 text-xs">
              <div>
                ...
                <input
                  className="w-full rounded border border-gray-300 dark:border-white/10 bg-white dark:bg-[#2C2C2C] p-1"
                  value={query}
            ...
            <div className="mt-2">
              ...
              {metaFilters.map((f, idx) => (
                <div key={idx} className="flex gap-1 mb-1">
                  <input
                    className="flex-1 rounded border border-gray-300 dark:border-white/10 bg-white dark:bg-[#2C2C2C] p-1 text-xs"
          ...
          <div className="mt-4 p-3 rounded-md border-2 border-blue-300 dark:border-blue-600 bg-blue-50 dark:bg-blue-900/20 space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2 text-xs">
              <div className="col-span-2">
                ...
                <select
                  className="w-full rounded border border-gray-300 dark:border-white/10 bg-white dark:bg-[#2C2C2C] p-1.5"
                  value={comragMode}
          ...
          <textarea
            className="w-full h-24 rounded-md border border-gray-300 dark:border-white/10 bg-white dark:bg-[#2C2C2C] p-2"
            value={promptText}
