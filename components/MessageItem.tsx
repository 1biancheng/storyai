      ...
      <div className="flex-1 pt-1">
        ...
        <div className="p-3 mt-1 rounded-lg bg-gray-100 border border-gray-200 dark:bg-white/5 dark:border-white/5 w-full relative group">
            {contentToCopy && !log.isLoading && log.agent !== AgentRole.SYSTEM && (
                <button
                    onClick={handleCopy}
                    className="absolute top-2 right-2 p-1.5 rounded-md bg-gray-200/50 dark:bg-[#2C2C2C] text-gray-500 dark:text-gray-400 opacity-0 group-hover:opacity-100 focus:opacity-100 transition-all hover:bg-gray-300/70 dark:hover:bg-black/40"
